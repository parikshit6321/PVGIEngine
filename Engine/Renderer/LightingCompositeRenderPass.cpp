...
void LightingCompositeRenderPass::Execute(ID3D12GraphicsCommandList * commandList, D3D12_CPU_DESCRIPTOR_HANDLE * depthStencilViewPtr,
...
void LightingCompositeRenderPass::Draw(ID3D12GraphicsCommandList * commandList, ID3D12Resource * objectCB, ID3D12Resource * matCB)
{
	SceneManager::GetScenePtr()->mQuadrObject->Draw(commandList, nullptr, nullptr, mSrvDescriptorHeap, 0, 0, 0, false);
}

void LightingCompositeRenderPass::BuildRootSignature()
{
...
void LightingCompositeRenderPass::BuildDescriptorHeaps()
{
...
void LightingCompositeRenderPass::BuildPSOs()
{
