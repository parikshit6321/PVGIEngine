...
float4 PS(VertexOut pin) : SV_Target
{
	...
	float3 indirectDiffuse = SampleSHIndirectLighting(position.xyz, normal.xyz) * albedo.rgb * PI_INVERSE * (1.0f - albedo.a) * (1.0f - floor(position.a));
	
	lighting.rgb += indirectDiffuse;
